...
outref0 = open(base_loc+'ref-'+str(max_train_tgt_len)+'-0', 'a')
outref1 = open(base_loc+'ref-'+str(max_train_tgt_len)+'-1', 'a')
outref2 = open(base_loc+'ref-'+str(max_train_tgt_len)+'-2', 'a')
outref3 = open(base_loc+'ref-'+str(max_train_tgt_len)+'-3', 'a')
